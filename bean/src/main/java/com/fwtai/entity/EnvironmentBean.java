...
public final class EnvironmentBean implements Serializable{
    ...
    private String kid;
    //@ApiModelProperty(notes = "审核人的主键kid",required = false,value = "当前登录人操作人,仅需附带token即可")
    ...
    @ApiModelProperty(notes = "摊位编号",required = true,value = "摊位编号")
    private String vendor_code;
    @ApiModelProperty(notes = "产品来源地",required = true,value = "产品来源地（填写至国家、省、市）")
    ...
    @ApiModelProperty(notes = "检测日期",required = true,value = "字符串,检测日期,格式:2019-10-22")
