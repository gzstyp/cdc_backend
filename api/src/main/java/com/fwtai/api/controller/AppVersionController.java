...
import com.fwtai.service.api.ApiAppVersionService;
...
public class AppVersionController{
    ...
    @Resource
    private ApiAppVersionService apiAppVersionService;
    ...
    public void getVersion(final HttpServletResponse response){
        ToolClient.responseJson(apiAppVersionService.getVersion(),response);
    }
}