...
import com.fwtai.service.api.ApiManageLocationService;
...
@RestController
@Api(tags = "经营场所")
@RequestMapping(ConfigFile.api_v10 +"manageLocation")
public class ManageLocationController{

    @Resource
	private ApiManageLocationService apiManageLocationService;
    ...
    public void queryById(final HttpServletRequest request,final HttpServletResponse response){
        ToolClient.responseJson(apiManageLocationService.queryById(ToolClient.getFormData(request)),response);
    }
