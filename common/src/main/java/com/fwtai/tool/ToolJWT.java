...
public final class ToolJWT implements Serializable{
    ...
    private final static long refresh_token = 1000 * 60 * 40L;//仅做token的是否需要更换新的accessToken标识,小于5分钟则提示需要更换新的accessToken
