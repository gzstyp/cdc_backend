...
public class ApiManageLocationService{
    ...
    public String add(final ManagerLocation manager){
        ...
        final String validate = ToolClient.validateField(formData,p_address,p_area_level,p_area_id,p_city_id,p_county_id,p_entrance,p_freeze,p_linkman,p_province_id,p_risk,p_site_letter,p_site_name);
    ...
    public String edit(final HttpServletRequest request){
        ...
        final String p_site_letter = "site_letter";
        final String p_site_name = "site_name";
        final String validate = ToolClient.validateField(formData,p_address,p_area_level,p_audit_user,p_city_id,p_county_id,p_entrance,p_freeze,p_linkman,p_mobile,p_province_id,p_remark,p_risk,p_site_letter,p_site_name,p_kid);
        if(validate != null)return validate;
