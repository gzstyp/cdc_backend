...
public class ApiManageLocationService{
    ...
    public String add(final ManagerLocation manager){
        ...
        final String validate = ToolClient.validateField(formData,p_address,p_area_id,p_city_id,p_county_id,p_entrance,p_freeze,p_linkman,p_mobile,p_province_id,p_risk,p_site_name,p_site_type);
        ...
        final String level = formData.getString(p_area_level);
        final Integer area_level = level == null ? 3 : Integer.parseInt(level);
        formData.put("area_level",area_level);
        if(site_letter == null){
    ...
    public String edit(final HttpServletRequest request){
        ...
        final String p_site_name = "site_name";
        final String p_site_type = "site_type";
        final String validate = ToolClient.validateField(formData,p_address,p_audit_user,p_entrance,p_freeze,p_linkman,p_mobile,p_remark,p_risk,p_site_name,p_site_type,p_kid);
        if(validate != null)return validate;
